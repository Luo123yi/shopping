...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse createOrder(Integer userId, Integer shippingId) {
        ...
        //step2：userId查询购物车中已选中的商品--》List<Cart>
    ...
    public ServerResponse alipay_callback(Map<String, String> map) {
        ...
        //step3：获取支付状态
        String tarde_status=map.get("trade_status");
        //step3：获取支付时间
        ...
        if (tarde_status.equals(Const.TRADE_SUCCESS)){
            //支付成功
            //更改订单状态，更改支付时间
    ...
    public ServerResponse query_order_pay_status(Long orderNo) {
        ...
        return ServerResponse.createServerResponseBySuccess("失败");
    }
    ...
    public ServerResponse pay(Order order) throws IOException {
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
                ...
                .setNotifyUrl("http://39.107.105.34:8080/order/alipay_callback.do")//支付宝服务器主动通知商户服务器里指定的页面http路径,根据需要设置
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                String filePath = String.format("/usr/ly/project/img/qr-%s.png",response.getOutTradeNo());
